...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Mac) | 13.1h | 120.9h | 539.7h | ~6726h* |
| Interactive human attention | 0.0h | 0.0h | 0.0h | 120.2h |
| Interactive AI generation | 1.0h | 1.0h | 2.0h | 162.2h |
| Worker-classified human attention | 0.0h | 0.0h | 0.2h | 0.2h |
| Worker/headless AI generation | 6.1h | 31.6h | 78.6h | 436.1h |
| Additive observed work | 7.1h | 32.6h | 80.8h | 718.7h |
| Interactive sessions | 1 | 1 | 6 | 450 |
| Worker sessions | 40 | 201 | 1,447 | 6,624 |
...
_AI session 365-day totals cover 179 days of local assistant session history (not extrapolated)._

## AI Model Usage (last 30 days)

| Model | Requests | Input | Output | Cache read | Cache Hit-Rate % | Session Count | Session Hours |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.6-terra | 13,760 | 59.0M | 1.5M | 558.6M | 90.4% | 1,325 | 49.1h |
| gpt-5.6-sol | 5,895 | 16.6M | 541K | 494.6M | 96.7% | 218 | 34.4h |
| gpt-5.6-luna | 7 | 287K | 397 | 0 | 0.0% | 7 | 0.0h |
| **Total** | **19,662** | **75.9M** | **2.1M** | **1,053.2M** | **93.3%** | **1,548** | **83.5h** |

_1,131.3M total tokens processed. 93.3% cache hit rate._
...
| gpt-5.6-terra | 18,186 | 76.0M | 2.0M | 728.2M | 90.5% | 1,792 | 64.2h |
| gpt-5.6-sol | 16,607 | 55.8M | 1.9M | 947.0M | 94.4% | 1,110 | 99.3h |
...
| gpt-5.6-luna | 44 | 503K | 3K | 958K | 65.6% | 14 | 0.1h |
...
| **Total** | **107,244** | **537.4M** | **25.0M** | **6,953.2M** | **92.8%** | **7,039** | **593.5h** |

_7,728.3M total tokens processed. 92.8% cache hit rate._
<!-- STATS-END -->
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-09-15 04:12 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
...
<div align="center">
  <a href="https://commit-history.com/spyderman4g63?metric=total" target="_blank" rel="noopener noreferrer">
    <picture>
      ...
      <img alt="spyderman4g63's cumulative total GitHub contributions" src="assets/contributions/total-light.svg" width="960" />
    </picture>
  </a>
</div>
