...
| User AI session hours | 1.8h | 3.4h | 6.3h | 6.3h |
| AI worker hours | 1.3h | 6.4h | 13.0h | 13.0h |
| AI concurrency hours | 3.8h | 10.6h | 21.3h | 21.3h |
| Interactive sessions | 4 | 6 | 8 | 8 |
| Worker sessions | 9 | 82 | 172 | 172 |
...
| gpt-5.5 | 5,371 | 22.5M | 838K | 149.0M | $110.89 | $402.57 | $499.85 |
...
| **Total** | **8,120** | **25.4M** | **1.8M** | **574.0M** | **$1,085.00** | **$5,816.67** | **$577.96** |

_617.6M total tokens processed. 93% cache hit rate._

_$6,394.63 total saved ($5,816.67 caching + $577.96 model routing vs all-Opus)._
...
| gpt-5.5 | 5,753 | 25.3M | 896K | 164.3M | $122.90 | $443.68 | $555.19 |
...
| **Total** | **58,505** | **358.4M** | **16.5M** | **4,324.4M** | **$8,522.79** | **$31,323.05** | **$6,566.74** |

_4,879.4M total tokens processed. 88.6% cache hit rate._

_$37,889.80 total saved ($31,323.05 caching + $6,566.74 model routing vs all-Opus)._
