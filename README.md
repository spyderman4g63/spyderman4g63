...
| AI concurrency hours | 1.8h | 16.5h | 56.5h | 509.5h |
| Interactive sessions | 0 | 5 | 18 | 286 |
| Worker sessions | 26 | 194 | 229 | 2,295 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 7,686 | 35.4M | 1.1M | 239.5M | $171.99 | $646.82 | $781.71 |
...
| **Total** | **8,292** | **36.5M** | **1.4M** | **298.6M** | **$329.88** | **$1,225.91** | **$826.35** |

_340.7M total tokens processed. 87.6% cache hit rate._

_$2,052.26 total saved ($1,225.91 caching + $826.35 model routing vs all-Opus)._
...
| gpt-5.5 | 13,386 | 60.5M | 2.0M | 402.2M | $293.74 | $1,086.15 | $1,331.69 |
...
| **Total** | **66,744** | **394.7M** | **18.0M** | **4,621.4M** | **$8,851.52** | **$32,544.62** | **$7,387.88** |

_5,218.2M total tokens processed. 88.6% cache hit rate._

_$39,932.49 total saved ($32,544.62 caching + $7,387.88 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-01 00:34 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
