...
| AI worker hours | 1.2h | 6.6h | 14.3h | 14.3h |
| AI concurrency hours | 1.6h | 10.2h | 23.3h | 23.3h |
| Interactive sessions | 1 | 5 | 8 | 8 |
| Worker sessions | 22 | 95 | 184 | 184 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 2,321 | 3K | 803K | 392.1M | $945.75 | $5,294.59 | $0.00 |
| gpt-5.5 | 5,595 | 23.1M | 859K | 162.9M | $116.10 | $439.99 | $524.58 |
...
| **Total** | **8,245** | **25.8M** | **1.7M** | **581.9M** | **$1,079.56** | **$5,805.06** | **$595.47** |

_625.8M total tokens processed. 93% cache hit rate._

_$6,400.53 total saved ($5,805.06 caching + $595.47 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 13,449 | 115.9M | 5.1M | 1,833.6M | $6,646.47 | $24,753.84 | $0.00 |
...
| gpt-5.5 | 6,670 | 29.3M | 1.0M | 193.3M | $142.99 | $522.10 | $646.59 |
...
| **Total** | **59,490** | **362.4M** | **16.7M** | **4,359.2M** | **$8,570.09** | **$31,477.12** | **$6,658.51** |

_4,919.3M total tokens processed. 88.6% cache hit rate._

_$38,135.62 total saved ($31,477.12 caching + $6,658.51 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-05 19:27 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
