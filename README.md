...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 2,277 | 115.9M | 841K | 303.0M | $2,553.97 | $4,091.54 | $0.00 |
| claude-sonnet-4-6 | 24,355 | 127.8M | 5.5M | 1,174.1M | $952.66 | $3,170.22 | $3,275.15 |
...
| **Total** | **29,337** | **287.9M** | **7.3M** | **1,649.3M** | **$3,696.66** | **$7,674.40** | **$4,052.77** |

_1,996.0M total tokens processed. 82.6% cache hit rate._

_$11,727.17 total saved ($7,674.40 caching + $4,052.77 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 2,288 | 115.9M | 841K | 303.0M | $2,256.63 | $4,091.54 | $0.00 |
| claude-sonnet-4-6 | 23,179 | 128.0M | 5.1M | 1,116.7M | $797.10 | $3,015.27 | $3,188.46 |
...
| **Total** | **28,422** | **292.6M** | **7.0M** | **1,599.2M** | **$3,282.97** | **$7,539.24** | **$4,031.57** |

_1,946.5M total tokens processed. 82.2% cache hit rate._

_$11,570.81 total saved ($7,539.24 caching + $4,031.57 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-03 05:42 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
