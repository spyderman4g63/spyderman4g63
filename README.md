...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 5,119 | 115.9M | 1.7M | 691.8M | $3,469.65 | $9,339.85 | $0.00 |
| claude-sonnet-4-6 | 27,301 | 127.8M | 6.3M | 1,399.9M | $1,050.36 | $3,779.92 | $3,595.38 |
...
| **Total** | **36,184** | **311.6M** | **9.3M** | **2,337.6M** | **$4,784.25** | **$13,705.79** | **$4,755.43** |

_2,728.9M total tokens processed. 85.7% cache hit rate._

_$18,461.22 total saved ($13,705.79 caching + $4,755.43 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 5,131 | 115.9M | 1.7M | 691.8M | $2,908.48 | $9,339.85 | $0.00 |
| claude-sonnet-4-6 | 24,546 | 128.0M | 5.4M | 1,162.9M | $815.29 | $3,139.85 | $3,261.23 |
...
| **Total** | **33,695** | **316.4M** | **8.4M** | **2,107.8M** | **$4,057.39** | **$13,085.51** | **$4,486.76** |

_2,497.5M total tokens processed. 84.4% cache hit rate._

_$17,572.27 total saved ($13,085.51 caching + $4,486.76 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-06 16:05 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
