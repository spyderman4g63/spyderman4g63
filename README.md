...
| AI worker hours | 1.7h | 14.6h | 43.4h | 255.7h |
| AI concurrency hours | 3.0h | 16.9h | 56.6h | 506.0h |
| Interactive sessions | 2 | 6 | 19 | 286 |
| Worker sessions | 32 | 224 | 263 | 2,295 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 7,217 | 33.6M | 1.0M | 226.3M | $162.89 | $611.14 | $740.74 |
...
| **Total** | **7,996** | **34.8M** | **1.4M** | **299.2M** | **$365.50** | **$1,376.49** | **$785.37** |

_340.6M total tokens processed. 87.8% cache hit rate._

_$2,161.86 total saved ($1,376.49 caching + $785.37 model routing vs all-Opus)._
...
| gpt-5.5 | 12,848 | 58.4M | 1.9M | 387.1M | $282.93 | $1,045.43 | $1,283.01 |
...
| **Total** | **66,206** | **392.6M** | **17.9M** | **4,606.3M** | **$8,840.71** | **$32,503.89** | **$7,339.20** |

_5,200.9M total tokens processed. 88.6% cache hit rate._

_$39,843.09 total saved ($32,503.89 caching + $7,339.20 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-29 01:51 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
