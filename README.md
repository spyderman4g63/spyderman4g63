...
| User AI session hours | 4.2h | 6.0h | 8.1h | 8.1h |
| AI worker hours | 1.2h | 8.9h | 15.2h | 15.2h |
| AI concurrency hours | 8.0h | 19.5h | 30.8h | 30.8h |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 4,539 | 6K | 2.1M | 639.1M | $1,874.34 | $8,628.10 | $0.00 |
| claude-sonnet-4-6 | 3,663 | 4K | 1.7M | 286.2M | $231.30 | $772.95 | $449.61 |
| gpt-5.5 | 3,329 | 15.0M | 533K | 87.0M | $70.43 | $235.13 | $316.72 |
...
| **Total** | **12,797** | **21.3M** | **4.8M** | **1,155.1M** | **$2,243.67** | **$10,015.97** | **$1,036.16** |

_1,253.4M total tokens processed. 92.2% cache hit rate._

_$11,052.13 total saved ($10,015.97 caching + $1,036.16 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 12,267 | 115.9M | 4.8M | 1,641.7M | $4,561.94 | $22,164.12 | $0.00 |
...
| gpt-5.5 | 3,224 | 13.6M | 518K | 84.6M | $74.16 | $228.49 | $296.74 |
...
| **Total** | **51,521** | **349.5M** | **14.8M** | **3,782.7M** | **$6,082.14** | **$27,849.45** | **$5,945.28** |

_4,301.9M total tokens processed. 87.9% cache hit rate._

_$33,794.74 total saved ($27,849.45 caching + $5,945.28 model routing vs all-Opus)._
